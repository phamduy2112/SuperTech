...
import {  changePassword, getUser,login,loginFacebook,logout,register, resetToken, updateImage, updateUser, userDetail, verifyOldPassword } from '../controllers/userController.js';
