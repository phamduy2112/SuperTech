...
export default function initModels(sequelize) {
  ...
  const replies_comment_product = _replies_comment_product.init(
    sequelize,
    DataTypes
  );
  ...
  user_discounts.belongsTo(discount, {
    as: "discount",
    foreignKey: "discount_id",
  });
  discount.hasMany(user_discounts, {
    as: "user_discounts",
    foreignKey: "discount_id",
  });
  product_colors.belongsTo(image_product, {
    as: "image",
    foreignKey: "image_id",
  });
  image_product.hasMany(product_colors, {
    as: "product_colors",
    foreignKey: "image_id",
  });
  ...
  products.belongsTo(infor_product, {
    as: "infor_product_infor_product",
    foreignKey: "infor_product",
  });
  infor_product.hasMany(products, {
    as: "products",
    foreignKey: "infor_product",
  });
  ...
  product_storage.belongsTo(product_colors, {
    as: "color",
    foreignKey: "color_id",
  });
  product_colors.hasMany(product_storage, {
    as: "product_storages",
    foreignKey: "color_id",
  });
  comment_product.belongsTo(products, {
    as: "product",
    foreignKey: "product_id",
  });
  products.hasMany(comment_product, {
    as: "comment_products",
    foreignKey: "product_id",
  });
  ...
  favorite_product.belongsTo(products, {
    as: "product",
    foreignKey: "product_id",
  });
  products.hasMany(favorite_product, {
    as: "favorite_products",
    foreignKey: "product_id",
  });
  product_colors.belongsTo(products, {
    as: "product",
    foreignKey: "product_id",
  });
  ...
  product_storage.belongsTo(products, {
    as: "product",
    foreignKey: "product_id",
  });
  products.hasMany(product_storage, {
    as: "product_storages",
    foreignKey: "product_id",
  });
  likes.belongsTo(replies_comment_product, {
    as: "reply",
    foreignKey: "replies_id",
  });
  replies_comment_product.hasMany(likes, {
    as: "likes",
    foreignKey: "replies_id",
  });
  ...
  replies_comment_product.belongsTo(user, {
    as: "user",
    foreignKey: "user_id",
  });
  user.hasMany(replies_comment_product, {
    as: "replies_comment_products",
    foreignKey: "user_id",
  });
