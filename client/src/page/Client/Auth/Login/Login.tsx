...
<div className="">
  <div className="flex overflow-hidden relative min-h-[100vh] bg-gradient-to-br from-purple-50 to-white">
    <div className="hidden lg:block lg:w-[55%] xl:w-[60%] relative overflow-hidden">
      ...
      <div className="relative top-[40%] left-[35%] translate-x-[-50%] translate-y-[-50%] z-10 text-white p-8 flex flex-col items-center hidden 2xl:flex">
        <div className="mb-8">
          <h1 className="text-[5rem] xl:text-[6rem] font-bold mb-4 text-center drop-shadow-lg">
            SuperTech
          </h1>
      ...
      <div className="absolute right-[-5%] top-[15%] z-10 animate-float">
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-b from-purple-400/20 to-transparent rounded-[3rem] blur-2xl"></div>
          <img 
            src={dienThoai} 
            alt="iPhone" 
            className="w-[450px] xl:w-[500px] object-contain relative z-10" 
          />
        </div>
      </div>
    ...
    <div className="2xl:hidden absolute top-4 left-4 z-20">
      <NavLink to="/" className="bg-white shadow-lg w-[4rem] h-[4rem] rounded-full flex items-center justify-center">
        <FaArrowLeft className="text-[2rem] text-customColor"/>
      </NavLink>
    </div>
    ...
    <div className="w-full lg:w-[45%] xl:w-[40%] flex justify-center items-center p-6">
      <div className="w-full max-w-[500px] p-4 2xl:p-8 flex flex-col justify-center z-10">
        <h2 className="text-[2.5rem] 2xl:text-[3rem] font-bold mb-4 text-center">Đăng nhập</h2>
