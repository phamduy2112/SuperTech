  ...
  return (
    ...
    <div className="flex flex-col h-full justify-center items-center p-4 md:p-10 gap-5 md:gap-7">
      ...
      <div className="h-full relative flex items-center justify-center">
        ...
        <div className="p-5 md:p-[30px] grid grid-cols-1 md:grid-cols-2 w-full h-full md:absolute">
          {/* Form Section */}
          <div className="p-4 md:p-6 bg-slate-200">
            <h1 className="text-[20px] md:text-[24px]">Biểu mẫu hỗ trợ</h1>
            <form className="grid grid-cols-1 md:grid-cols-3 gap-2" action="">
              <div className="col-span-1 md:col-span-2">
                <label className="text-[12px] md:text-[13px] text-[#9854CC]" htmlFor="">
                  Email
                </label>
                <input type="text" className="w-full h-[40px] md:h-[45px]" />
              </div>
              <div>
                <label className="text-[12px] md:text-[13px] text-[#9854CC]" htmlFor="">
                  Phone
              ...
              <div className="col-span-1 md:col-span-3">
                ...
                <textarea className="w-full h-[200px] md:h-[400px]" />
                <div className="bg-[#9854CC] w-full h-[45px] md:h-[51px] flex justify-center items-center mt-2">
