          ...
          <div className="flex space-x-6">
            <div className="flex-1 space-y-6">
              ...
              <div className="flex justify-between">
                  ...
                  <button className="px-10 py-5 rounded-2xl text-white bg-customColor font-medium hover:bg-red-500 hover:shadow-md hover:text-black transition duration-300">
                    Xóa tất cả
                  </button>
              </div>
            </div>
