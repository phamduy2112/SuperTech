          ...
          <div className="mx-auto">
            ...
            <div className="flex space-x-6">
              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="flex items-center justify-between bg-white p-5 rounded-lg shadow my-[3rem]">
                ...
                {[1, 2, 3].map((item) => (
                  ...
                  className="bg-white py-5 rounded-lg shadow space-y-1">
                    <div className="flex space-x-[5rem] items-center p-5">
                      <input type="checkbox" className="w-7 h-7 items-center justify-center" />
                      <img
                    ...
                    <div className="flex justify-end space-x-4 items-center">
                      ...
                      <div className="flex flex-col items-end leading-normal text-lg ">
