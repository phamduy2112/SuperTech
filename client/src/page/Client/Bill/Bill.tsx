        ...
        <div className="lg:w-2/3 bg-white shadow-lg rounded-lg">
          <div className="flex flex-col items-start px-8 py-8 rounded-t-3xl bg-green-50 shadow-lg">
            ...
            <div className="flex justify-between w-full items-center mb-6">
              ...
              <button className="bg-purple-700 hover:bg-purple-800 text-white font-semibold px-6 py-3 rounded-full text-sm">
                Tiếp tục mua sắm
              </button>
            </div>
          </div>
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                <h3 className="text-2xl font-semibold text-gray-800">
                  Điện thoại | Iphone 11 pro max - màu tím lục bảo
                </h3>
                <p className="text-lg text-gray-500 mt-2">Mã đơn hàng: W199883</p>
                <p className="text-lg text-gray-500">Thời gian đặt: 19:00 15/11/2023</p>
              </div>
              <div className="text-right">
                <h4 className="text-xl font-semibold text-gray-800">Giao hàng đến</h4>
                <p className="text-lg text-gray-500">
                  197 Nguyễn Thị Thập, Phường Bình Thuận, Quận 7
                </p>
                <p className="text-lg text-gray-500">Dự kiến giao hàng: 19:45</p>
              </div>
            </div>

            {/* Pricing Summary */}
            <div className="bg-gray-50 p-6 rounded-lg mb-6">
              <h4 className="text-xl font-semibold text-gray-800 mb-3">Tổng trị giá (tạm tính)</h4>
              ...
              <div className="flex justify-between text-xl font-semibold text-gray-800 mt-3">
                <span>Giảm giá:</span>
                <span>-10,000₫</span>
              </div>
              <div className="flex justify-between text-2xl font-bold text-green-600 mt-4">
                <span>Tổng cộng:</span>
                <span>164,000₫</span>
              </div>
            </div>
