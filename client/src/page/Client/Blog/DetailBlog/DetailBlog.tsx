...
<Container>
      ...
      <div className="grid grid-cols-1 gap-4">
        {posts.map((post) => (
          <div key={post.id} className="bg-white rounded-md shadow-lg">
            ...
            />
            <p className="p-4 text-gray-800 font-semibold text-sm md:text-base lg:text-lg">
              {post.title}
            </p>
          </div>
        ))}
  ...
  <div className="space-y-4">
    ...
    <div className="flex space-x-4 items-start">
      ...
      />
      <textarea
        className="w-full h-32 p-2 border border-gray-300 rounded-md placeholder:text-lg md:placeholder:text-2xl placeholder:p-3 text-lg sm:text-xl md:text-2xl"
