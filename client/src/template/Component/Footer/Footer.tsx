...
function Footer() {
  ...
  return (
    <div className="w-full m-auto mt-[1.5rem] bg-white">
      {/* Top Section */}
      <div className="bg-[#7500CF] sm:rounded-t-[2rem] w-full py-[2rem] flex justify-center items-center">
      ...
      <div className="w-[90%] xl:w-[80%] m-auto py-[3rem] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[3rem]">
        ...
        <div className="col-span-1">
          ...
          <div className="flex gap-[2rem] mt-[1.5rem] mb-[2rem]">
            <RiHeadphoneFill className="text-[4rem] text-[#7500CF] font-semibold" />
            <div>
      ...
      <div className="w-full bg-[#E5E5E5] py-[2rem]">
        <div className="w-[90%] xl:w-[80%] m-auto flex flex-col md:flex-row justify-between items-center gap-[2rem]">
          <p className="text-[1.4rem] text-[#34005C] text-center md:text-left">
            SuperTech - Cửa Hàng Chuyên Các Mặt Hàng Công Nghệ.
          </p>
          <img src={nganHang} alt="Payment Methods" className="w-[20rem] md:w-[25rem]" />
        </div>
      </div>
    </div>
  );
